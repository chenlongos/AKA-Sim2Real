export const CAR_ARM_XML = `<mujoco>
    ...
    <worldbody>
        ...
        <body name="car" pos="0 0 0.22">
            <freejoint/>
            <body name="camera_body" pos="0.4 0 0.25" euler="0 0 0">
                <camera name="firstperson" pos="0 0 0" euler="90 -90 0" fovy="110"/>
                <geom type="box" pos="0 0 0" size="0.1 0.05 0.05" rgba="0 0 0 1" contype="0" conaffinity="0"/>
                <geom type="cylinder" fromto="0.02 0 0 0.12 0 0" size="0.02" rgba="0 1 0 1" contype="0" conaffinity="0"/>
            </body>

            <geom type="box" size="0.5 0.3 0.15" rgba="0.2 0.6 0.8 1" mass="10"/>

            <body name="wheel_fl" pos="0.4 0.3 -0.1">
                <joint name="wheel_fl_joint" type="hinge" axis="0 0 1" range="-100 100"/>
                <geom type="cylinder" size="0.12 0.05" fromto="0 -0.05 0 0 0.05 0" rgba="0.1 0.1 0.1 1" mass="1"/>
            </body>
            <body name="wheel_fr" pos="0.4 -0.3 -0.1">
                <joint name="wheel_fr_joint" type="hinge" axis="0 0 1" range="-100 100"/>
                <geom type="cylinder" size="0.12 0.05" fromto="0 -0.05 0 0 0.05 0" rgba="0.1 0.1 0.1 1" mass="1"/>
            </body>
            <body name="wheel_rl" pos="-0.4 0.3 -0.1">
                <joint name="wheel_rl_joint" type="hinge" axis="0 0 1" range="-100 100"/>
                <geom type="cylinder" size="0.12 0.05" fromto="0 -0.05 0 0 0.05 0" rgba="0.1 0.1 0.1 1" mass="1"/>
            </body>
            <body name="wheel_rr" pos="-0.4 -0.3 -0.1">
                <joint name="wheel_rr_joint" type="hinge" axis="0 0 1" range="-100 100"/>
                <geom type="cylinder" size="0.12 0.05" fromto="0 -0.05 0 0 0.05 0" rgba="0.1 0.1 0.1 1" mass="1"/>
            </body>
        </body>
    </worldbody>
